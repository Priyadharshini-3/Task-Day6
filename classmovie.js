...
// of only those movies in the input array with a rating of "PG". You may assume the input array 
// is full of Movie instances. The returned array need not be full.

 movie[] getPG(movie[] mov) {
...
class movie = new movie( "Casino Royal", "Eon Productions", "PG13");
